        ...
        <div class="container">
            <form action="top.php" method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5"><input type="text" name="gasoline_mileage" required>
                        <p style="display:inline">km</p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-5"><h6>割り勘する人数</h6></div>
                    <div class="col-sm-5"><input type="text" name="man" required><p style="display:inline">人</p></div>
                </div>
                <div class="row">
                    <div class="col-sm-5">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5"><input type="text" name="highway" style="text-align: right;" value="0">
                        <p style="display:inline">円</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-5"><h6>駐車場代金（円</h6></div>
                    <div class="col-sm-5"><input type="text" name="parking" style="text-align: right;" value="0"><p style="display:inline">円</p></div>
                </div>
                <div class="row">
                    <div class="col-sm-5"><h6>レンタカー代金（円）</h6></div>
                    <div class="col-sm-5"><input type="text" name="rent_a_car" style="text-align: right;" value="0"><p style="display:inline">円</p></div>
                </div>
                <div class="row">
